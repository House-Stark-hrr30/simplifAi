    ...
    <div>
      <div className="section-about">
        <div className="center-text margin-bottom-big">
          ...
          >Welcome to simplifAi<p> Your data's important -- find out what it has to say </p></h2>
        </div>
        ...
        <div className="row">
          <div className="col-1-of-4">
            <div className="feature-box">
              ...
              >Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, ipsum sapiente aspernatur.</p>
            </div>
          </div>
      ...
      <section className="section-stories">
        ...
        <div className="center-text margin-bottom-big">
          ...
          >See what people are saying about simplifAi</h2>
        </div>
          ...
          <div className="story">
            ...
            <div className="story__text">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, ipsum sapiente aspernatur libero repellat quis consequatur
                ...
                repellat quis consequatur ducimus quam nisi exercitationem omnis.</p>
            </div>
          </div>
        </div>
